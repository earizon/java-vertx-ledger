...
data class SimpleTransfer (
        ...
        override fun getId(): UUID = UUID.randomUUID() // TODO:(0) FIX get from getTransferID
        ...
        override fun getAmount(): MonetaryAmount = Money.of(0, _TXInput.amount.currency)
        override fun getInvoice(): String = "" // TODO:(0)
